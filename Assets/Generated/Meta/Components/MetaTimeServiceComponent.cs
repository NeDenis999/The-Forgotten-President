...
public partial class MetaContext {
    ...
    public MetaEntity SetTimeService(Code.Services.ITimeService newValue) {
        if (hasTimeService) {
    ...
    public void ReplaceTimeService(Code.Services.ITimeService newValue) {
...
public partial class MetaEntity {
    ...
    public void AddTimeService(Code.Services.ITimeService newValue) {
