...
public partial class MetaContext {
    ...
    public MetaEntity SetViewService(Code.Services.IViewService newValue) {
        if (hasViewService) {
    ...
    public void ReplaceViewService(Code.Services.IViewService newValue) {
...
public partial class MetaEntity {
    ...
    public void AddViewService(Code.Services.IViewService newValue) {
