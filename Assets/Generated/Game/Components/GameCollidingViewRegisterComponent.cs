...
public partial class GameContext {
    ...
    public CollidingViewRegister collidingViewRegister { get { return collidingViewRegisterEntity.collidingViewRegister; } }
    public bool hasCollidingViewRegister { get { return collidingViewRegisterEntity != null; } }

    public GameEntity SetCollidingViewRegister(Code.Services.IRegisterService<Code.IViewController> newValue) {
        if (hasCollidingViewRegister) {
            throw new Entitas.EntitasException("Could not set CollidingViewRegister!\n" + this + " already has an entity with CollidingViewRegister!",
    ...
    public void ReplaceCollidingViewRegister(Code.Services.IRegisterService<Code.IViewController> newValue) {
...
public partial class GameEntity {
    ...
    public CollidingViewRegister collidingViewRegister { get { return (CollidingViewRegister)GetComponent(GameComponentsLookup.CollidingViewRegister); } }
    public bool hasCollidingViewRegister { get { return HasComponent(GameComponentsLookup.CollidingViewRegister); } }

    public void AddCollidingViewRegister(Code.Services.IRegisterService<Code.IViewController> newValue) {
        var index = GameComponentsLookup.CollidingViewRegister;
        var component = (CollidingViewRegister)CreateComponent(index, typeof(CollidingViewRegister));
